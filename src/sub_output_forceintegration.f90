					...
					if      (face .eq. 1)then
						...
						do k = ks,ke-1
							do j = js,je-1
								...
								temp00 = 1.d0/sqrt(blk(m0)%dxidx(1,ip,j ,k )**2 + blk(m0)%dxidx(2,ip,j ,k )**2 + blk(m0)%dxidx(3,ip,j ,k )**2)  
								temp10 = 1.d0/sqrt(blk(m0)%dxidx(1,ip,jp,k )**2 + blk(m0)%dxidx(2,ip,jp,k )**2 + blk(m0)%dxidx(3,ip,jp,k )**2)
								temp01 = 1.d0/sqrt(blk(m0)%dxidx(1,ip,j ,kp)**2 + blk(m0)%dxidx(2,ip,j ,kp)**2 + blk(m0)%dxidx(3,ip,j ,kp)**2)
								temp11 = 1.d0/sqrt(blk(m0)%dxidx(1,ip,jp,kp)**2 + blk(m0)%dxidx(2,ip,jp,kp)**2 + blk(m0)%dxidx(3,ip,jp,kp)**2) 
						...
						do k = ks,ke-1
							do j = js,je-1
								...
								temp00 = 1.d0/sqrt(blk(m0)%dxidx(1,im,j ,k )**2 + blk(m0)%dxidx(2,im,j ,k )**2 + blk(m0)%dxidx(3,im,j ,k )**2)  
								temp10 = 1.d0/sqrt(blk(m0)%dxidx(1,im,jp,k )**2 + blk(m0)%dxidx(2,im,jp,k )**2 + blk(m0)%dxidx(3,im,jp,k )**2)
								temp01 = 1.d0/sqrt(blk(m0)%dxidx(1,im,j ,kp)**2 + blk(m0)%dxidx(2,im,j ,kp)**2 + blk(m0)%dxidx(3,im,j ,kp)**2)
								temp11 = 1.d0/sqrt(blk(m0)%dxidx(1,im,jp,kp)**2 + blk(m0)%dxidx(2,im,jp,kp)**2 + blk(m0)%dxidx(3,im,jp,kp)**2) 
						...
						do k = ks,ke-1
							do i = is,ie-1
								...
								temp00 = 1.d0/sqrt(blk(m0)%dxidx(4,i ,jp,k )**2 + blk(m0)%dxidx(5,i ,jp,k )**2 + blk(m0)%dxidx(6,i ,jp,k )**2)  
								temp10 = 1.d0/sqrt(blk(m0)%dxidx(4,ip,jp,k )**2 + blk(m0)%dxidx(5,ip,jp,k )**2 + blk(m0)%dxidx(6,ip,jp,k )**2)
								temp01 = 1.d0/sqrt(blk(m0)%dxidx(4,i ,jp,kp)**2 + blk(m0)%dxidx(5,i ,jp,kp)**2 + blk(m0)%dxidx(6,i ,jp,kp)**2)
								temp11 = 1.d0/sqrt(blk(m0)%dxidx(4,ip,jp,kp)**2 + blk(m0)%dxidx(5,ip,jp,kp)**2 + blk(m0)%dxidx(6,ip,jp,kp)**2) 
						...
						do k = ks,ke-1
							do i = is,ie-1
							  ...
							  pc = (blk(m0)%pri_v(5,i,j ,k ) + blk(m0)%pri_v(5,ip,j ,k ) &
								   ...
								   temp00 = 1.d0/sqrt(blk(m0)%dxidx(4,i ,jm,k )**2 + blk(m0)%dxidx(5,i ,jm,k )**2 + blk(m0)%dxidx(6,i ,jm,k )**2)  
								   temp10 = 1.d0/sqrt(blk(m0)%dxidx(4,ip,jm,k )**2 + blk(m0)%dxidx(5,ip,jm,k )**2 + blk(m0)%dxidx(6,ip,jm,k )**2)
								   temp01 = 1.d0/sqrt(blk(m0)%dxidx(4,i ,jm,kp)**2 + blk(m0)%dxidx(5,i ,jm,kp)**2 + blk(m0)%dxidx(6,i ,jm,kp)**2)
								   temp11 = 1.d0/sqrt(blk(m0)%dxidx(4,ip,jm,kp)**2 + blk(m0)%dxidx(5,ip,jm,kp)**2 + blk(m0)%dxidx(6,ip,jm,kp)**2) 
						...
						do j = js,je-1
							do i = is,ie-1
							  ...
							  temp00 = 1.d0/sqrt(blk(m0)%dxidx(7,i ,j ,kp)**2 + blk(m0)%dxidx(8,i ,j ,kp)**2 + blk(m0)%dxidx(9,i ,j ,kp)**2)  
							  temp10 = 1.d0/sqrt(blk(m0)%dxidx(7,ip,j ,kp)**2 + blk(m0)%dxidx(8,ip,j ,kp)**2 + blk(m0)%dxidx(9,ip,j ,kp)**2)
							  temp01 = 1.d0/sqrt(blk(m0)%dxidx(7,i ,jp,kp)**2 + blk(m0)%dxidx(8,i ,jp,kp)**2 + blk(m0)%dxidx(9,i ,jp,kp)**2)
							  temp11 = 1.d0/sqrt(blk(m0)%dxidx(7,ip,jp,kp)**2 + blk(m0)%dxidx(8,ip,jp,kp)**2 + blk(m0)%dxidx(9,ip,jp,kp)**2) 
						...
						do j = js,je-1
							do i = is,ie-1
							  ...
							  pc = (blk(m0)%pri_v(5,i,j ,k ) + blk(m0)%pri_v(5,ip,j ,k ) &
								   ...
								   temp00 = 1.d0/sqrt(blk(m0)%dxidx(7,i ,j ,km)**2 + blk(m0)%dxidx(8,i ,j ,km)**2 + blk(m0)%dxidx(9,i ,j ,km)**2)  
								   temp10 = 1.d0/sqrt(blk(m0)%dxidx(7,ip,j ,km)**2 + blk(m0)%dxidx(8,ip,j ,km)**2 + blk(m0)%dxidx(9,ip,j ,km)**2)
								   temp01 = 1.d0/sqrt(blk(m0)%dxidx(7,i ,jp,km)**2 + blk(m0)%dxidx(8,i ,jp,km)**2 + blk(m0)%dxidx(9,i ,jp,km)**2)
								   temp11 = 1.d0/sqrt(blk(m0)%dxidx(7,ip,jp,km)**2 + blk(m0)%dxidx(8,ip,jp,km)**2 + blk(m0)%dxidx(9,ip,jp,km)**2) 
